...
// with let, we are able to replace the contents of enemies witha new array
...
function buildEnemyCards() {
  ...
  section.innerHTML = enemies.map(enemy => {
...
function addUserToList(ev) {
  ...
  ev.preventDefault(); //STOP the submit from happening (no page reload)
